...
<script msgType="text/javascript" src="/path/to/jquery/jquery-1.10.2.min.js"></script>
<script msgType="text/javascript" src="/path/to/bootstrap/js/bootstrap.min.js"></script>
<script msgType="text/javascript" src="/path/to/bootstrapValidator.min.js"></script>
```
