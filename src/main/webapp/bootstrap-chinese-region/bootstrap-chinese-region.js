...
(function(root,factory){
	...
	ChineseRegion.prototype.onSubmit = function(e) {
		if(this.submitType == 'id'){
            ...
            console.log(this.areas[this.areas.length-1].id)
	...
	if(result && result.length==3){
        ...
        document.getElementById("cusprovince").value = result[0].name;
        document.getElementById("cusarea").value = result[1].name+result[2].name;
	}
		return result;
	};
	/**
